"""UPSTREAM FILE - NOT USED IN OUR FORK

This file comes from mistraltest upstream (v1.2.2).
Our fork uses simple `auto_approve: bool` instead of AgentMode enum.

Kept for reference and potential future use.
To activate: remove this docstring and update imports in agent.py, app.py, etc.
"""
