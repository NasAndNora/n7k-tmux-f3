...
class CLIToolResultEvent(BaseEvent):
    """Event emitted when a CLI tool result is ready to be displayed as a widget."""

    tool_info: Any  # Type is Any to avoid circular import (actually CLIToolInfo)
