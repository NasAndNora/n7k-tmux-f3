...
from vibe.cli.autocompletion.ai_tag import AITagController
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._completion_manager = MultiCompletionManager([
            ...
            AITagController(AITagCompleter(), self),  # @cc, @claude, @g, @gemini
            PathCompletionController(PathCompleter(), self),  # @file paths
        ])
